...
contract ExampleFlashSwap is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        if (amountToken > 0) {
            ...
            uint256 amountRequired = PancakeLibrary.getAmountsIn(factory, amountToken, path)[0];
            ...
            uint256 amountRequired = PancakeLibrary.getAmountsIn(factory, amountETH, path)[0];
